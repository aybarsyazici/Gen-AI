          ...
          <div>
            ...
            <div className="like-dislike-container">
              ...
              <Button
                ...
                onClick={() => handleDecline(wordExplanation, currentWordIndex)}
...
> = ({
  ...
  const createTour = () => {
    ...
    refs.push({
      ...
      content:
        "You'll be asked if you like this change or not. You'll also be required to write a small explanation on why you think we implemented this change",
