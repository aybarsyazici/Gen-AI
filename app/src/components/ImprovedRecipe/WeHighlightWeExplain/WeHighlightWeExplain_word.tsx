...
export const ImprovedRecipeDisplayWordScale: React.FC<ImprovedRecipeDisplayProps> = ({ improvedRecipe, 
    ...
    const createTour = () => {
        ...
        refs.push({
            ...
            content: 'Clicking on a marked change will bring this popup. In this pop up you\'ll find explanation on why this change was made. Click on the checkmark to finish reviewing.',
        ...
        refs.push({
            title: 'Wrapping up!',
            content: 'After you reviewing all the changes you\'ll be able to submit your results!',
