...
const ClickableWord: React.FC<ClickableWordProps> = React.memo(({
    ...
    console.log('word rerender: ', currentWordIndex, "& Got Refs: ", likeButtonRef, popRef, spanRef);
    return (
        <Popover
            content={
                <div>
...
export const ImprovedRecipeDisplayWordScale: React.FC<ImprovedRecipeDisplayProps> = ({ improvedRecipe, 
    ...
    const createTour = () => {
        ...
        refs.push({
            ...
            content: 'The changes will already be marked for you. Either in sentence scale or word scale(remember you can change the scale from the menu!)',
        ...
        refs.push({
            ...
            content: 'Clicking on a marked change will bring this popup. You\'ll be asked to write a small explanation on why you think we implemented this change',
        ...
        refs.push({
            title: 'Wrapping up!',
            content: 'After you explaining all the changes you\'ll be able to submit your results!',
